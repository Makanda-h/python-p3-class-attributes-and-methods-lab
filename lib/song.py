class Song:
    ...
    @classmethod
    # counts the total number of songs obj
    ...
    @classmethod
    # keeps track of all artists
    def add_to_artist(cls, artist):
         if artist not in cls.artists:
              cls.artists.append(artist)

    @classmethod
    # keeps track of the number of songs per genre
    ...
    @classmethod
    # keeps track of the number of songs per artist
